...
class MotionLoader(Dataset):
        ...
        def __getitem__(self, idx):
            ...
            return np.expand_dims(masked_input, axis=0), np.expand_dims(gt_image, axis=0), np.expand_dims(blend_zeros, axis=0), np.expand_dims(blend_image, axis=0), np.expand_dims(tail_image, axis=0) # it will (batch, 1, 69, 240)
